<template>
    <section>
        ...
        <div class="customer_list">
            <div class="list" v-for="item in customerList" @click="tapUser(item)" :class="{'check' : item.userId == currentUser.userId}">
        ...
        <div class="customer">
            ...
            <div class="customer_body" ref="customer">
                <div class="content_box" :class="[item.messageType == 1 ? 'r' : 'l']" v-for="item in msgList">
