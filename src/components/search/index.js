                            ...
                            return <el-col span={col}>
                                <el-form-item label={item.label}>
                                    <el-date-picker
                                        ...
                                        on-input={(val) => {
                                        const startTime = val[0] ? `${this.util.formatTimeRange(val[0])} 00:00:00` : val[0]
                                        const endTime = val[1] ? `${this.util.formatTimeRange(val[1])} 23:59:59` : val[1]
            ...
            <div on-keyup={this.handleKeyUp} class="search-form">
                <el-form model={this.form} label-width="100px">
                    <el-row class="search">
                        ...
                        <el-col span={24} class="second-form" v-open-more={this.isOpen}>
                            {
                                // 隐藏选项
                        ...
                        <el-col span={24}>
                            <el-form-item>
                                <el-button size="small" nativeOn-click={this.search} type="primary">搜索</el-button>
                                <el-button size="small" nativeOn-click={this.reset}>重置</el-button>
                                {this.$slots['buttons']}
                            </el-form-item>
                        </el-col>
                    </el-row>
